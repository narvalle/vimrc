...
noremap <Leader>ff :ff<cr>
noremap <Leader>wq :wq<cr>
noremap <Leader>fp :fp<cr>
noremap <Leader>nt :NERDTree<cr>
noremap <leader><cr> <cr><c-w>h:q<cr>
noremap <Leader>ff :ff<cr>
noremap <Leader>ht :below terminal<cr>
noremap <Leader>vt :vertical term<cr>
...
nnoremap <silent> <Leader>fp :Prettier<CR>
...
let g:lightline = {
      ...
      \   'right':[['fileformatcon'],['lineinfo'], ['filetypeicon', 'filetype']]
       \ },
        \ 'component_function': {
          \   'filetypeicon': 'MyFiletype',
          \   'fileformatcon': 'MyFileformat',
        \ }
      \ }
function! MyFiletype()
